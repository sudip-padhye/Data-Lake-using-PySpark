...
os.environ['BUCKET']=config.get('AWS', 'BUCKET_NAME')
...
def process_song_data(spark, input_data, output_data):
    '''
    Description: This function loads song_data from S3 and processes it by extracting the songs and artist tables and then again loaded back to S3
        
    Input:
    spark       - Spark Session object
    input_data  - the location of song_data from where the file is loaded
    output_data - the location where the results will be stored
    '''
...
def process_log_data(spark, input_data, output_data):
    '''
    Description: This function loads log_data from S3 and processes it by extracting the songs and artist tables and then again loaded back to S3. Also output from previous function is used in by spark.read.json command
    ...
    print('Filtering data for the NextSong')
...
def main():
    ...
    print('Spark session created and initialized')
    
    input_data = "s3a://udacity-dend/"
    output_data = "s3://"+os.environ['BUCKET']+"/"
